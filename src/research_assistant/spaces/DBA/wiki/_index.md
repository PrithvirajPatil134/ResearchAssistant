...
|------|------|------|----------|
| [dr-trebucq](./entities/dr-trebucq.md) | person | Potential DBA Thesis Supervisor | working |
| [prof-barneto](./entities/prof-barneto.md) | person | Confirmed DBA Thesis Supervisor / University Professor / Director of the Doctorate in Business Administration / DU Research Instructor (Introduction to Management Research) | working |
| [prof-cardoso](./entities/prof-cardoso.md) | person | DBA Programme Coordinator | seed |
| [prof-galan](./entities/prof-galan.md) | person | Potential DBA Thesis Supervisor (referred via Herrbach forward) / Quantitative Methods Instructor (UE2) | seed |
| [prof-herrbach](./entities/prof-herrbach.md) | person | DBA Course Instructor (Human Resources and Organizational Behavior) — declined thesis supervision (topic 'too macro'); redirected to Barneto and Galan | seed |
