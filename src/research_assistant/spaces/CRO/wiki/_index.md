...
- 2026-07-02: `communication/email_prof_mukhopadhyay_session7_submission_20260702.md` added (sent email submitting the Session 7 theories-in-use analysis, noting work-travel absence and offering to present another time). `entities/prof-mukhopadhyay.md` updated (communication history + mentions_in_communications).
- 2026-06-12: `feedback/response_prof_mukhopadhyay_thesis_feedback_20260612.md` added (Mukhopadhyay's reply to the May 23 thesis-direction email: narrow scope, case-study method, text analytics for large document volume, consider RBV/dynamic capabilities). `entities/prof-mukhopadhyay.md` updated (communication history + mentions_in_communications; cleared the no-direct-communication note).
- 2026-05-07: `entities/prof-mukhopadhyay.md` created (Batch 2 ingest)
- 2026-05-07: `_index.md` created
